  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 py-20 px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Mes Stacks & Outils</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 text-left">
          {stacks.map((category) => (
            <div key={category.title}>
              <h3 className="font-semibold text-lg mb-4 text-blue-900 dark:text-blue-300">{category.title}</h3>
